...
a = int(input("Enetr the Number: ")) #taking number as input
if(0<a<10):                           #checking if the number is a single digit number
    ...
    print("cube root of number is:",math.cbrt(a)) #calculating the cube root of the number using math.cbrt() function and printing the result
